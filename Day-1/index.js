...
// console.log(); // This will output 8
...
// console.log(z); // This will output 58




// let JohnData = ['John Doe', 30,  ['123-456-7890',[334613,'555555','abdallah'],315715], ['123-456-7890','334613',315715]];

// console.log(JohnData[2][1][2]); // This will output '123-456-7890'


// let data2 = [
//     ['abdallah', 'ahmed'],
//     [['012345456','1236987'], ['2038877', '998742']],
//     ['123-456-7890', '334613', 315715],
//     ['123-456-7890', '334613', 315715],
//     ['Ali', ['avfda@GamepadHapticActuator.',[1236697874, '12369877',[12211,'abdallah']]]]
// ]
// console.log("PRINT HERE", data2[
//     data2.length - 1
// ][
//     data2[data2.length - 1].length - 1
// ][
//     data2[data2.length - 1][data2[data2.length - 1].length - 1].length  - 1
// ][
//     data2[
//     data2.length - 1
// ][
...
// console.log(`${x.toString()} + ${y.toString()} = ${x+y}`)
...
// let data = ['abdallah',27,'01255898945']


// let data = {
//     'abdallah' : {"name" : 'abdallah','age' :27,'phone' : ['1478',5555]},
//     'ahmed' : {"name" : 'ahmed','age' :20,'phone' : ['127674478',55555215]},
//     'ali' : {"name" : 'ali','age' :5,'phone' : ['1434478',7777]}
// }

// console.log(data.ali.phone[1])
